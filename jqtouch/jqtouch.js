...
(function($) {
    $.jQTouch = function(options) {
        ...
        function init(options) {
            ...
            var defaults = {
                addGlossToIcon: (/android/i.test(navigator.userAgent) ? false: true),
            ...
            if (jQTSettings.icon || jQTSettings.icon4) {
                ...
                if (jQTSettings.icon4 && (window.devicePixelRatio && window.devicePixelRatio === 2) || (document.documentElement.clientWidth > 600)) {
